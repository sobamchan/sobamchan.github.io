...
The application was successfully sent to DAAD. It is now being processed by the system and you will shortly receive a confirmation message that can be called up via "Application and funding overview". This process may take a few minutes.
When applying for the first time the message "There are currently no applications assigned to your user" may appear during this waiting time. Once the confirmation message about the new application is displayed, please click on "Open all".
